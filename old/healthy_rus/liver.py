...
class Liver(OrganModel):
    ...
    def get_state_size(self):
        return 5   # P_hv, C_bil, C_amm, C_alb, резерв
    ...
    def get_derivatives(self, t, state, inputs):
        ...
        # Гемодинамика – здоровая (без повреждения)
        P_mes = (P_sa + P_sv) / 2
        ...
        # Метаболизм – здоровый, functional = 1
        ...
        # Влияние на концентрации в крови
