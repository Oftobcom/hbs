...
class WholeBodyModel:
    """
    Полная модель организма здорового человека.
    Вещества в крови: 'tox', 'bilirubin', 'ammonia', 'albumin' (вирус отсутствует).
    """
    def __init__(self,
                 heart_params=None,
                 lungs_params=None,
        ...
        self.heart = Heart4Chambers(**(heart_params or {}))
    ...
    def derivatives(self, t, y):
        ...
        dV_total = dV_kidney + gitract_out.get('absorption_water',0)
        ...
        # Лёгочные вены
        Q_from_lungs = (V_lungs[1] - P_pv) / self.lungs.R2
    ...
    def compute_outputs(self, t, y):
        ...
        outputs = {
            ...
            'Q_aortic': heart_out['Q_aortic'], 'Q_pulmonary': heart_out['Q_pulmonary'],
